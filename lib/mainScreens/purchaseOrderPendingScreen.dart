...
class _PurchaseOrdersPendingListState extends State<PurchaseOrdersPendingList> {
  bool isExpand = false;
  String name = "";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Purchase Orders Pending List"),
        actions: [
          IconButton(
            icon: const Icon(
              Icons.post_add,
          ...
          child: Card(
            ...
            child: TextField(
              decoration: InputDecoration(
                ...
                hintText: ("Search PurchaseOrders"),
              ),
              onChanged: ((value) {
                setState(() {
                  name = value;
          ...
          return (snapshots.connectionState == ConnectionState.waiting)
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    PurchaseOrder model = PurchaseOrder.fromJson(
