...
class CustTransUploadScreen extends StatefulWidget {
  final Customers? model;

  CustTransUploadScreen({this.model});

  @override
  _CustTransUploadScreenState createState() => _CustTransUploadScreenState();
}

class _CustTransUploadScreenState extends State<CustTransUploadScreen> {
  ...
  saveInfo(String downloadUrl) {
    ...
    ref.doc(uniqueIdName).set({
      ...
      "customerName": widget.model!.customerName,
      "customerContact": widget.model!.customerContact,
      "customerAddress": widget.model!.customerAddress,
