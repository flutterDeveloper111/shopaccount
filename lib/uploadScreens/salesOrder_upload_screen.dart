...
class SalesOrderUploadScreen extends StatefulWidget {
  SalesOrder? model;
  BuildContext? context;
  SalesOrderUploadScreen({this.model, this.context});
  _SalesOrderUploadScreenState createState() => _SalesOrderUploadScreenState();
}

class _SalesOrderUploadScreenState extends State<SalesOrderUploadScreen> {
  ...
  getUser() async {
    setState(() {
      ...
      salesOrderNameController.text = "Name";
      salesOrderInfoController.text = "Information";
  ...
  saveDataToFirestore(String downloadUrl) {
    ...
    ref.doc(uniqueIdName).set({
      ...
      (value) {
        final custRef = FirebaseFirestore.instance.collection("salesOrders");
